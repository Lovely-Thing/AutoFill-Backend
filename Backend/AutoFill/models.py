...
class User(AbstractBaseUser):
    ...
    companyname_position = models.CharField(max_length=50, unique=False, blank=True, null=True, default="前")
...
class StopLinkSettingModel(models.Model):
    ...
    contact_url =  models.TextField(unique=False, blank=True, null=True)
    site_url =  models.TextField(unique=False, blank=True, null=True)
...
class DMtextSetModel(models.Model):
    ...
    text2000 =  models.TextField(unique=False, blank=True, null=True)  
    ...
    dmTitle =  models.CharField(max_length=250, unique=False, blank=True, null=True) 
    register_date =  models.CharField(max_length=150, unique=False, blank=True, null=True) 
    recent_send_date =  models.CharField(max_length=150, unique=False, blank=True, null=True)     
...
class PerDMGroupDmListModel(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)  
    name =  models.CharField(max_length=50, unique=False, blank=True, null=True)
    mailaddress =  models.CharField(max_length=250, unique=False, blank=True, null=True) 
    contact_url =  models.TextField(unique=False, blank=True, null=True) 
    site_url =  models.TextField(unique=False, blank=True, null=True) 
    phone_num =  models.CharField(max_length=50, unique=False, blank=True, null=True) 
    auto_manual =  models.CharField(max_length=50, unique=False, blank=True, null=True)  
